...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    M.prototype.config = {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], y = [], p = [], m = [], v = function () {
            ...
            }), c.layBody.scrollTop(0), c.layMain.find("." + f).remove(), c.layMain.find("tbody").html(y.join("")), c.layFixLeft.find("tbody").html(p.join("")), c.layFixRight.find("tbody").html(m.join("")), c.renderForm(),  c.haveInit ? c.scrollPatch() : setTimeout(function () {
                c.scrollPatch()
        ...
        u.on("mousemove", function (e) {
            ...
            }),  a.renderForm("checkbox")) : (a.setCheckData(l, n)), layui.event.call(this, s, "checkbox(" + f + ")", {
                checked: n,
